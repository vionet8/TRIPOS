...
3. **2日分の走行予算と余力を計算すること（最重要）**：
   - 2日予算 = 1日上限 × 2
   - 余力 = 2日予算 − 最短ルート総所要時間
   - 例（2歳・最短8h・1日上限6h45m）：2日予算=13h30m、余力=5h30m
4. **この余力を使って3パターンの「ルート×エリア」を提案すること**：
   ...
   - いずれも「1日目の実走行が1日上限を超えない」こと。2日目も同様
...
{{
  ...
  "drive_budget": {{
    ...
    "spare_capacity_label": "この旅は約5時間30分の余力があります。中央道や北陸道ルートも十分選べます。"
  }},
  "special_pick": {{
    "id": "エリアID",
    "name": "エリア名",
